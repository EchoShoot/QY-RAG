...
export function PipelineLogSheet({
  ...
  const handleViewResult = () => {
    const params: NavigateToDataflowResultProps = {
      id: messageId,
      [PipelineResultSearchParams.AgentId]: id,
      [PipelineResultSearchParams.DocumentId]: uploadedFileData?.id,
      [PipelineResultSearchParams.AgentTitle]: agent.title,
      [PipelineResultSearchParams.IsReadOnly]: 'true',
      [PipelineResultSearchParams.Type]: 'dataflow',
      [PipelineResultSearchParams.CreatedBy]: uploadedFileData?.created_by,
      [PipelineResultSearchParams.DocumentExtension]: uploadedFileData?.extension,
    } as NavigateToDataflowResultProps;
    setDataflowParams(params);
  ...
  return (
    ...
    {dataflowModalOpen && dataflowParams && (
      <DataflowResultModal
        open={dataflowModalOpen}
        onClose={() => setDataflowModalOpen(false)}
